...
class Actor(models.Model):
    ...
    description = models.TextField('Описание')
    image = models.ImageField('Изображения', upload_to = 'actors/', blank = True)
...
class MovieShots(models.Model):
    ...
    description = models.TextField('Описание')
    image = models.ImageField('Изобржение', upload_to = 'movie_shots/', blank = True)
...
class Review(models.Model):
    ...
    parent = models.ForeignKey(
        'self', verbose_name = 'Родитель', on_delete = models.SET_NULL, null = True, blank = True, related_name = 'children'
    )
